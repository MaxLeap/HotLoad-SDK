...
- (void)setUp
{
    ...
    [HotLoad setUsingTestConfiguration:YES];
}
...
- (void)runTest:(NSString *)testName
{
    ...
    RCTRootView *rootView = [[RCTRootView alloc] initWithBundleURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://localhost:8081/HotLoadDemoAppTests/InstallUpdateTests/testcases/%@.bundle?platform=ios&dev=true", testName]]
                                                        moduleName:testName
