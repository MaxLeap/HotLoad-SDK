// Type definitions for React Native HotLoad pligin.
...
type SyncStatusChangedCallback = (status: HotLoad.SyncStatus) => void;
...
interface LocalPackage extends Package {
     ...
     */
    install(installMode: HotLoad.InstallMode, minimumBackgroundDuration?: number): ReactNativePromise<void>;
}
...
interface Package {
    ...
    /**
     * The internal label automatically given to the update by the HotLoad server. This value uniquely identifies the update within its deployment.
     */
    label: string;
...
interface RemotePackage extends Package {
    /**
     * Downloads the available update from the HotLoad service.
     *
...
interface SyncOptions {
     ...
     * Defaults to hotLoad.InstallMode.ON_NEXT_RESTART.
     */
    installMode?: HotLoad.InstallMode;

    /**
     * Specifies when you would like to install updates which are marked as mandatory.
     * Defaults to hotLoad.InstallMode.IMMEDIATE.
     */
    mandatoryInstallMode?: HotLoad.InstallMode;
...
declare namespace HotLoad {
    ...
    /**
     * Asks the HotLoad service whether the configured app deployment has an update available.
     *
     * @param deploymentKey The deployment key to use to query the HotLoad server for an update.
     */
    ...
    /**
     * Notifies the HotLoad runtime that an installed update is considered successful.
     */
    ...
    enum SyncStatus {
        /**
         * The HotLoad server is being queried for an update.
         */
        CHECKING_FOR_UPDATE,
        ...
        /**
         * An available update is being downloaded from the HotLoad server.
         */
        DOWNLOADING_PACKAGE,
        ...
        /**
         * The app is up-to-date with the HotLoad server.
         */
        UP_TO_DATE,
